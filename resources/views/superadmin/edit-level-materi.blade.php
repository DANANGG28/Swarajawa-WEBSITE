...
@section('konten')
    <div class="flex flex-col gap-6 max-w-5xl mx-auto pt-4 pb-10">
        ...
        <nav class="flex items-center gap-2 font-caption text-caption text-gray-500">
            ...
            <span class="material-symbols-outlined text-[14px]">chevron_right</span>
            <span class="text-on-surface font-bold truncate">Sunting Level {{ $levelMateri->urutan }}</span>
        </nav>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    ...
                    <label class="flex flex-col gap-1.5">
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="urutan" min="1" value="{{ old('urutan', $levelMateri->urutan) }}" required
                                   class="w-full rounded-xl border border-gray-200 bg-gray-50 pl-11 pr-4 py-3 font-body text-sm outline-none focus:border-primary-500 focus:bg-white transition-all">
                        </div>
                    ...
                    <label class="flex flex-col gap-1.5">
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="reward_exp" min="0" value="{{ old('reward_exp', $levelMateri->reward_exp) }}" required
                                   placeholder="100"
                                   class="w-full rounded-xl border border-gray-200 bg-gray-50 pl-11 pr-4 py-3 font-body text-sm outline-none focus:border-primary-500 focus:bg-white transition-all">
                        </div>
