...
@section('konten')
    <div class="flex flex-col gap-6 mt-6">
        ...
        <section class="bg-surface-container-lowest rounded-2xl p-5 shadow-sm border border-gray-100 flex flex-col lg:flex-row lg:items-end justify-between gap-4">
            <form method="GET" class="flex flex-col sm:flex-row sm:items-end gap-3 flex-1">
                ...
                <div class="flex flex-col gap-1.5 flex-1 max-w-sm">
                    ...
                    <div class="relative flex items-center">
                        ...
                        @if (request('q'))
                            <a href="{{ route('superadmin.soal', array_filter(['level_materi_id' => $level->id, 'pembahasan_id' => request('pembahasan_id'), 'tipe_soal' => request('tipe_soal')])) }}"
            ...
            <a href="{{ route('superadmin.soal.create', array_filter(['level_materi_id' => $level->id, 'pembahasan_id' => request('pembahasan_id')])) }}" class="flex items-center justify-center gap-2 rounded-full bg-primary-600 hover:bg-primary-700 text-on-primary font-body text-body font-bold px-6 py-2.5 shadow-sm transition-colors whitespace-nowrap">
                        ...
                        <section class="bg-surface-container-lowest rounded-3xl shadow-sm border border-gray-100 overflow-hidden flex flex-col">
                            ...
                            <div class="px-5 sm:px-6 py-4 bg-gradient-to-r from-gray-50/90 via-surface-container-low/40 to-white border-b border-gray-100 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                                ...
                                <div class="flex items-center gap-2 shrink-0 self-end sm:self-center">
                                    <a href="{{ route('superadmin.soal.create', ['level_materi_id' => $level->id, 'pembahasan_id' => $pembahasan->id]) }}"
                                        ...
                                        <div class="p-4 sm:p-5 hover:bg-surface-container-low/30 transition-colors flex flex-col gap-3">
                                            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                                                ...
                                                <div class="flex items-center gap-2 shrink-0 self-end sm:self-center">
                                                    ...
                                                    <form method="POST" action="{{ route('superadmin.soal.destroy', $s) }}" onsubmit="return confirm('Apakah Anda yakin ingin menghapus butir soal ini?')">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit"
                                                                title="Hapus Soal"
            ...
            <div class="bg-surface-container-lowest rounded-3xl shadow-sm border border-gray-100 p-12 text-center text-gray-500">
                <div class="flex flex-col items-center justify-center gap-3">
                    ...
                    <div class="pt-2">
                        ...
                        @else
                            <a href="{{ route('superadmin.soal.create', array_filter(['level_materi_id' => $level->id, 'pembahasan_id' => request('pembahasan_id')])) }}"
