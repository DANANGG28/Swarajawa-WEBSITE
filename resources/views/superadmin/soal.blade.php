            ...
            <details class="group">
                <summary class="cursor-pointer list-none px-5 py-4 flex items-center justify-between">
                    <div class="flex items-center gap-2">
                        ...
                        <span class="font-heading text-heading font-bold text-on-surface">Tambah Soal (materi mana wae)</span>
                    </div>
        ...
        <section class="flex flex-col gap-3">
                ...
                <div class="bg-surface-container-lowest rounded-2xl p-5 shadow-sm border border-gray-100 flex flex-col gap-3">
                    <div class="flex flex-col sm:flex-row sm:items-start justify-between gap-3">
                        <div class="flex flex-col min-w-0">
                            ...
                            <span class="font-caption text-caption text-gray-500">Pembuat: {{ $s->pembuat ?? 'Superadmin' }}</span>
                        </div>
            ...
            @empty
                <div class="bg-surface-container-lowest rounded-2xl p-10 text-center border border-gray-100">
                    ...
                    <p class="font-body text-body text-gray-500 mt-2">Durung ana soal.</p>
                </div>
            @endforelse
