                        ...
                        <section class="relative overflow-hidden rounded-[20px] bg-gradient-to-r from-primary-700 via-primary-600 to-primary text-on-primary p-8 shadow-md">
                            ...
                            <div class="relative z-10 flex flex-col">
                                <div class="flex items-center gap-space-xs mb-2">
                                    ...
                                    <span class="font-label-upper text-label-upper text-yellow-300 uppercase tracking-widest font-bold">Pembelajaran Mandiri SMP</span>
                                </div>
                                <h1 class="font-display text-display text-on-primary font-extrabold tracking-tight mb-space-xs">
                                    Selamat Datang, Andi Prasetyo!
                                </h1>
                                <p class="font-body text-body text-primary-fixed leading-relaxed mb-6">
                                    Ayo lanjutkan pembelajaran Bahasa Jawa hari ini. Selesaikan tantangan harian dan tingkatkan peringkatmu di kelas 7A!
                                </p>
                                <div class="flex flex-wrap items-center gap-space-md">
                                    <a href="#" class="inline-flex items-center gap-space-xs bg-color-white text-primary-700 hover:bg-surface-container-low transition-all duration-200 px-6 py-3 rounded-full font-body text-body font-bold shadow-sm hover:shadow-md">
                                        <svg class="w-4 h-4 text-primary-700" fill="currentColor" viewBox="0 0 24 24">
                                            <path d="M8 5v14l11-7z"></path>
                                        </svg>
                                        <span>Lanjutkan Belajar (Level 2: Sandhangan Swara)</span>
                                    </a>
                                    <a href="#" class="inline-flex items-center gap-space-xs bg-on-primary/15 hover:bg-on-primary/25 text-on-primary transition-all duration-200 px-5 py-3 rounded-full font-body text-body font-semibold backdrop-blur-sm">
                                        ...
                                        <span>Kuis Bicara (STT/Audio)</span>
                                    </a>
                                </div>
                            </div>
                        </section>
                        ...
                        <section class="grid grid-cols-1 md:grid-cols-3 gap-gutter">
                            ...
                            <div class="bg-orange-300 rounded-2xl p-5 flex flex-col justify-between shadow-sm hover:shadow-md transition-all relative overflow-hidden">
                                <div class="flex items-start justify-between mb-4 z-10">
                                    <span class="font-label-upper text-label-upper uppercase tracking-wider text-tertiary font-bold">Streak Harian</span>
                                ...
                                <div class="z-10">
                                    <div class="flex items-baseline gap-space-xs mb-1">
                                        <span class="font-stat-number text-stat-number font-extrabold text-on-tertiary-fixed">5</span>
                                    ...
                                    <p class="font-caption text-caption text-tertiary font-medium">
                                        Gaspol setiap hari! Rekor: 12 Hari
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="bg-yellow-300 rounded-2xl p-5 flex flex-col justify-between shadow-sm hover:shadow-md transition-all relative overflow-hidden">
                                ...
                                <div class="z-10">
                                    <div class="flex items-baseline gap-space-xs mb-1">
                                        <span class="font-stat-number text-stat-number font-extrabold text-on-tertiary-fixed">1,450</span>
                                    ...
                                    <div class="flex items-center gap-space-sm font-caption text-caption text-tertiary font-medium">
                                        <span class="font-semibold text-on-tertiary-fixed">Tingkat: Menengah</span>
                                        <span class="text-tertiary">•</span>
                                        <span class="text-green-500 font-bold">+50 XP hari ini</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="bg-primary-fixed rounded-2xl p-5 flex flex-col justify-between shadow-sm hover:shadow-md transition-all relative overflow-hidden">
                                ...
                                <div class="z-10">
                                    <div class="flex items-baseline gap-space-xs mb-1">
                                        <span class="font-stat-number text-stat-number font-extrabold text-on-primary-fixed">14</span>
                                        <span class="font-heading text-heading font-bold text-primary">Aksara Dikuasai</span>
                                    </div>
                                    <p class="font-caption text-caption text-on-primary-fixed-variant font-medium">
                                        70% Hanacaraka Baku selesai ditelusuri
                                    </p>
                                </div>
                            </div>
                        </section>
                                ...
                                <div class="relative z-10 flex flex-col">
                                    <div class="flex items-center justify-between gap-space-sm mb-3">
                                        <span class="font-label-upper text-label-upper font-bold uppercase tracking-wider text-primary-fixed">
                                            Tantangan Hari Ini • Bonus +100 EXP
                                        </span>
                                        <div class="flex items-center gap-1 text-primary-fixed font-caption text-caption">
                                            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                                <circle cx="12" cy="12" r="10"></circle>
                                                <polyline points="12 6 12 12 16 14"></polyline>
                                            </svg>
                                            <span>14j 20m lagi</span>
                                        </div>
                                    </div>
                                    <h2 class="font-heading text-heading font-extrabold text-on-primary leading-snug mb-2">
                                        Tebak Busana Adat & Aksara Ha-Na-Ca-Ra-Ka
                                    </h2>
                                    <p class="font-caption text-caption text-on-primary/80 mb-6 leading-relaxed">
                                        Jodohkan blangkon, beskap, dan jarik dengan tata aksara swara yang benar. Buktikan pengetahuan kebudayaanmu!
                                    </p>
                                </div>
                                <div class="relative z-10 flex items-center justify-between pt-2">
                                    <div class="flex -space-x-2">
                                        <div class="w-7 h-7 rounded-full bg-surface-container-highest flex items-center justify-center font-caption text-caption font-bold text-primary">S</div>
                                        <div class="w-7 h-7 rounded-full bg-orange-300 flex items-center justify-center font-caption text-caption font-bold text-tertiary">D</div>
                                        <div class="w-7 h-7 rounded-full bg-yellow-300 flex items-center justify-center font-caption text-caption font-bold text-on-surface">B</div>
                                        <span class="pl-3 font-caption text-caption text-primary-fixed self-center">+18 teman belajar</span>
                                    </div>
                                    <button type="button" class="bg-color-white text-primary-700 hover:bg-surface-container-low transition px-5 py-2.5 rounded-full font-body text-body font-bold shadow-sm">
                                        Mulai Sekarang
                                    </button>
                                </div>
                            </div>
                                ...
                                <div class="flex items-center gap-space-md bg-surface-container-lowest/80 rounded-xl p-3">
                                    <div class="relative w-12 h-12 flex-shrink-0">
                                        <svg class="w-12 h-12 -rotate-90" viewBox="0 0 36 36">
                                            ...
                                            <path class="text-pink-500" d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" fill="none" stroke="currentColor" stroke-dasharray="75, 100" stroke-linecap="round" stroke-width="3.5"></path>
                                        </svg>
                                        <span class="absolute inset-0 flex items-center justify-center font-label-upper text-label-upper font-bold text-on-surface">75%</span>
                                    </div>
                                    <div class="flex flex-col flex-1 min-w-0">
                                        <span class="font-body text-body font-bold text-on-surface truncate">9 dari 12 Selesai</span>
                                        <a href="#" class="font-caption text-caption text-secondary font-bold hover:underline inline-flex items-center gap-1 mt-0.5">
                            ...
                            <div class="flex items-center justify-between">
                                <div>
                                    <h2 class="font-display text-heading font-extrabold text-on-surface tracking-tight">
                                        Jalur Pembelajaran • Kurikulum SMP Kelas 7
                                    </h2>
                                    <p class="font-caption text-caption text-on-surface-variant">
                                        Tata krama unggah-ungguh, penulisan aksara, dan pengetahuan kebudayaan Jawa.
                                    </p>
                                </div>
                                <a href="#" class="font-caption text-caption text-primary-600 font-bold hover:text-primary-700 hover:underline flex items-center gap-1">
                            ...
                            <div class="flex flex-col gap-space-xs">
                                ...
                                <div class="bg-surface-container-lowest rounded-2xl p-5 shadow-sm hover:shadow-md transition flex flex-col md:flex-row md:items-center justify-between gap-space-md">
                                    <div class="flex items-start gap-space-md">
                                        ...
                                        <div class="flex flex-col">
                                            <div class="font-label-upper text-label-upper font-bold uppercase tracking-wider mb-1 text-gray-500">
                                                LEVEL 1 <span class="mx-1.5">•</span> <span class="text-green-500">SELESAI</span>
                                            </div>
                                            <h3 class="font-heading text-heading font-bold text-on-surface mb-1">
                                                Ngoko Lugu & Krama Alus
                                            </h3>
                                            <p class="font-caption text-caption text-on-surface-variant">
                                                12 Latihan • Kosakata keluarga, pidato singkat, dan salam pergaulan.
                                            </p>
                                        </div>
                                    </div>
                                    <div class="flex items-center gap-space-md justify-between md:justify-end self-end md:self-center w-full md:w-auto pt-2 md:pt-0">
                                        <div class="hidden sm:flex flex-col text-right">
                                            <span class="font-label-upper text-label-upper font-bold text-green-500">Skor: 96/100</span>
                                            <span class="font-caption text-caption text-gray-500">Tercatat</span>
                                        </div>
                                        <button type="button" class="px-5 py-2 rounded-full font-body text-body font-semibold text-on-surface-variant bg-gray-50 hover:bg-surface-container-high transition">
                                            Latihan Lagi
                                        </button>
                                    </div>
                                </div>

                                <!-- Level 2 (In Progress - Active) -->
                                <div class="bg-surface-container-lowest rounded-2xl p-5 shadow-sm hover:shadow-md transition flex flex-col md:flex-row md:items-center justify-between gap-space-md bg-gradient-to-r from-surface-container-lowest via-surface-container-low/40 to-surface-container-lowest">
                                    <div class="flex items-start gap-space-md flex-1">
                                        ...
                                        <div class="flex flex-col flex-1 max-w-lg">
                                            <div class="font-label-upper text-label-upper font-bold uppercase tracking-wider mb-1 text-gray-500">
                                                LEVEL 2 <span class="mx-1.5">•</span> <span class="text-primary-600">SEDANG BERJALAN</span>
                                            </div>
                                            <h3 class="font-heading text-heading font-bold text-primary-700 mb-1">
                                                Sandhangan Swara & Tracing Kanvas
                                            </h3>
                                            <p class="font-caption text-caption text-on-surface-variant mb-3">
                                                Wulu, Suku, Taling, Tarung, Pepet dengan goresan digital referensi FR-22.
                                            </p>
                                            <div class="flex items-center gap-space-sm w-full">
                                                ...
                                                <span class="font-caption text-caption font-bold text-primary-600 whitespace-nowrap">4 / 12 Pelajaran (68%)</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="flex items-center justify-end self-end md:self-center w-full md:w-auto pt-2 md:pt-0">
                                        <a href="#" class="px-6 py-2.5 rounded-full font-body text-body font-bold text-on-primary bg-primary-600 hover:bg-primary-700 transition shadow-sm">
                                            Lanjutkan Belajar
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="bg-surface-container-lowest/60 rounded-2xl p-5 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-space-md opacity-75">
                                    <div class="flex items-start gap-space-md">
                                        ...
                                        <div class="flex flex-col">
                                            <div class="font-label-upper text-label-upper font-bold uppercase tracking-wider mb-1 text-gray-500">
                                                LEVEL 3 <span class="mx-1.5">•</span> <span class="text-gray-500">TERKUNCI</span>
                                            </div>
                                            <h3 class="font-heading text-heading font-bold text-gray-500 mb-1">
                                                Pakaian Adat & Makna Filosofi
                                            </h3>
                                            <p class="font-caption text-caption text-gray-500">
                                                FR-21 Puzzle busana adat Jawa Gaya Ngayogyakarta & Surakarta.
                                            </p>
                                        </div>
                                    </div>
                                    <div class="self-end md:self-center">
                                        <span class="font-caption text-caption text-gray-500 italic bg-gray-50 px-4 py-2 rounded-full">
                                            Terkunci: Selesaikan Level 2 terlebih dahulu
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div class="bg-surface-container-lowest/60 rounded-2xl p-5 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-space-md opacity-75">
                                    <div class="flex items-start gap-space-md">
                                        ...
                                        <div class="flex flex-col">
                                            <div class="font-label-upper text-label-upper font-bold uppercase tracking-wider mb-1 text-gray-500">
                                                LEVEL 4 <span class="mx-1.5">•</span> <span class="text-gray-500">TERKUNCI</span>
                                            </div>
                                            <h3 class="font-heading text-heading font-bold text-gray-500 mb-1">
                                                Peribahasa Jawa & Roro Jonggrang
                                            </h3>
                                            <p class="font-caption text-caption text-gray-500">
                                                Bebasan, saloka, dan apresiasi cerita rakyat dengan aksara murda.
                                            </p>
                                        </div>
                                    </div>
                                    <div class="self-end md:self-center">
                                        <span class="font-caption text-caption text-gray-500 italic bg-gray-50 px-4 py-2 rounded-full">
                                            Terkunci: Selesaikan Level 3 terlebih dahulu
                                        </span>
                                    </div>
                                </div>
                            </div>
