            ...
            btn?.addEventListener('click', async () => {
                ...
                try {
                    ...
                    feedback.innerHTML = `
                        ...
                        <p class="font-body text-body text-on-surface-variant mt-1">Kunci: <strong>${res.detail?.kunci ?? '-'}</strong> • Total EXP ${res.total_exp} • Streak ${res.current_streak} dina</p>`;
