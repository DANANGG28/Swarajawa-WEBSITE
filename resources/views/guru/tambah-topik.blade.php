        ...
        <section class="bg-surface-container-lowest rounded-3xl shadow-sm border border-gray-100 p-6 sm:p-8">
            <div class="flex items-center gap-3.5 pb-5 mb-6 border-b border-gray-100">
                ...
                <div>
                    ...
                    <p class="font-body text-xs text-gray-500 mt-0.5">Topik menjadi kelompok materi tertinggi; setiap topik dapat memuat beberapa unit materi.</p>
                </div>
            </div>

            <form method="POST" action="{{ route('guru.topik.store') }}" class="flex flex-col gap-5">
                @csrf
                ...
                <label class="flex flex-col gap-1.5">
                    ...
                    <textarea name="deskripsi" rows="3" placeholder="Keterangan singkat tentang topik ini..."
