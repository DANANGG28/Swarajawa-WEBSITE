...
@section('konten')
    <div class="flex flex-col gap-6 max-w-7xl mx-auto pt-2 pb-10 mt-4">
        ...
        <nav class="flex items-center gap-2 font-caption text-caption text-gray-500 flex-wrap">
            ...
            <span class="text-on-surface font-bold text-primary-700">Topik</span>
        </nav>
        ...
        <section class="bg-surface-container-lowest rounded-3xl p-4 sm:p-5 shadow-sm border border-gray-100 flex flex-col sm:flex-row items-stretch sm:items-center gap-3.5">
            <form method="GET" action="{{ route('guru.topik') }}" class="relative flex-1">
                ...
                @if (request('q'))
                    <a href="{{ route('guru.topik') }}" title="Hapus pencarian"
            ...
            <a href="{{ route('guru.topik.create') }}"
                    ...
                    @foreach ($topikList as $topik)
                        <div class="p-4 sm:p-5 hover:bg-surface-container-low/40 transition-colors flex flex-col md:flex-row md:items-center justify-between gap-4">
                            ...
                            <div class="flex items-center gap-2 shrink-0 self-end md:self-center pt-2 md:pt-0 border-t md:border-t-0 border-gray-100 w-full md:w-auto justify-end flex-wrap">
                                <a href="{{ route('guru.level-materi', ['topik_id' => $topik->id]) }}"
                                ...
                                <a href="{{ route('guru.topik.edit', $topik) }}"
                                   title="Sunting topik"
                                ...
                                <form method="POST" action="{{ route('guru.topik.destroy', $topik) }}"
