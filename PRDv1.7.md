...
| FR-12 | Manajemen Soal oleh Guru | Website HARUS menyediakan panel bagi guru untuk membuat soal baru (pilih materi → buat soal → simpan) serta CRUD/edit/hapus **soal miliknya sendiri** (guru tidak dapat mengubah/menghapus soal buatan guru lain). | Guru | Should |
